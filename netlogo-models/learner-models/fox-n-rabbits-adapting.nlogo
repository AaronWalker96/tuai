...
rabbits-own [snoozing%]               ;; everyone has a %age preference to snooze
foxes-own   [snoozing% energy]        ;; every fox also has an energy value
...
to setup-rabbits
  ...
  [ set color white
    ...
    set snoozing% 90 + (random 10)      ;; set a high preference for snoozing
  ]
end
...
to move-foxes
  ...
  [ if (trigger snoozing%)
    ...
    [                                  ;; ... eat it & gain energy ...
      ...
      ask one-of rabbits               ;; ... so hatch a new one
      [ hatch 1
        [ set snoozing% (mutate snoozing% 5) ]
      ]
    ]
  ]
end
...
"" ""
PENS
"rabbits" 1.0 0 -16777216 true "" "plot mean [snoozing%] of rabbits"
"foxes" 1.0 0 -2674135 true "" "plot mean [snoozing%] of foxes"
